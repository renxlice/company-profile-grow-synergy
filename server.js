...
async function bootstrap() {
  ...
  server.get('/test', (req, res) => {
    res.json({ 
      ...
      firebase: process.env.NODE_ENV === 'production' ? 'ENABLED' : 'MOCK'
    });
  });
  ...
  // Try NestJS with Handlebars
  try {
    console.log('🚀 Starting NestJS application with Handlebars...');
    console.log('📋 Environment check:');
    console.log('   NODE_ENV:', process.env.NODE_ENV);
    console.log('   Firebase:', process.env.NODE_ENV === 'production' ? 'ENABLED' : 'MOCK');
    ...
    console.log('✅ NestJS with Handlebars initialized successfully!');
    console.log('🔥 Firebase integration:', process.env.NODE_ENV === 'production' ? 'ACTIVE' : 'MOCK MODE');
    console.log('📄 Handlebars templates ready for rendering');
    ...
    server.get('/', (req, res) => {
      console.log('🏠 Serving fallback homepage...');
      res.send(`
        <!DOCTYPE html>
        <html>
        <head>
          ...
          <div class="min-h-screen bg-blue-50 flex items-center justify-center">
            <div class="text-center">
              ...
              <div class="mt-8 text-sm text-gray-500">
                <p>NestJS/Handlebars tidak tersedia - Mode Fallback</p>
                <p>Firestore Data: Tidak dapat dimuat</p>
              </div>
            </div>
          </div>
        </body>
          ...
          <div class="min-h-screen bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto px-4 py-12">
              ...
              <div class="mt-8 p-4 bg-yellow-100 border border-yellow-400 rounded">
                <p class="text-yellow-800">⚠️ Mode Fallback - Data Firestore tidak tersedia</p>
              </div>
        ...
        <body>
          <div class="min-h-screen bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto px-4 py-12">
              ...
              <p class="text-gray-600">Artikel dan insights tentang data analitik.</p>
              <div class="mt-8 p-4 bg-yellow-100 border border-yellow-400 rounded">
                <p class="text-yellow-800">⚠️ Mode Fallback - Data Firestore tidak tersedia</p>
              </div>
              <a href="/" class="text-blue-600 hover:underline mt-8 inline-block">← Kembali ke Home</a>
      ...
      res.send(`
        ...
        <body class="bg-gray-100 min-h-screen flex items-center justify-center">
          <div class="max-w-md w-full bg-white rounded-lg shadow-md p-6">
            ...
            <div class="mt-8 p-4 bg-yellow-100 border border-yellow-400 rounded">
              <p class="text-yellow-800">⚠️ Mode Fallback - Admin tidak tersedia</p>
            </div>
  ...
  server.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`🔥 Firebase: ${process.env.NODE_ENV === 'production' ? 'ENABLED' : 'MOCK MODE'}`);
